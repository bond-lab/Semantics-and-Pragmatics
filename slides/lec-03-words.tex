...
\item Permissible differentiation via \textbf{clarification}:
  \begin{quote}
    \eng{Here is a \ul{grain}, or \ul{granule}, of the substance.}\\
    \eng{* The cover is \ul{green}, \{or,that is to say\} \ul{purple}.}
  \end{quote}
  and \textbf{contrast}:
  \begin{quote}
    \eng{Here is a \ul{grain} or, more exactly, \ul{granule}}\\
    \eng{* He likes \ul{alsations}, or more exactly, \ul{spaniels}}
  \end{quote}
\end{itemize}
