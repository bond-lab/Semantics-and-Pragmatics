...
%\fill[white] (0,0) circle (1);
\endscope
\draw (0.25,0) circle (0.5) node [text=black] {$a$}
      (1,0) circle (1.5) node [text=black,right] {$b$};
% outline
\end{tikzpicture}}
&
\scalebox{2}{
...
%\fill[white] (1,0) circle (1);
\endscope
\draw (0.2,0) circle (1) node [text=black] {$a$}
      (1,0) circle (1.5) node [text=black,right] {$b$};
% outline
\end{tikzpicture}}
...
\draw (-0.8,0) circle (1) 
      ...
      (-0.4,0) circle (1) 
      (-0.2,0) circle (1) 
      (0.0,0) circle (1) node [text=black] {$a$}
      (0.2,0) circle (1) 
%      (0.25,0) circle (0.5) 
      (1,0) circle (1.5) node [text=black,right] {$b$};
% outline
...
%\fill[white] (1,0) circle (1);
\endscope
\draw (-.75,0) circle (1) node [text=black] {$a$}
      (1.75,0) circle (1) node [text=black] {$b$};
% outline
\end{tikzpicture}}
